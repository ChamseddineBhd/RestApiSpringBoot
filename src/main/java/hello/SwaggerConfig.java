...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("Do not start from scratch baby!")
                .version(GreetingController.API_VERSION)
                .build();
    }
    ...
    private Predicate<String> paths() {
        ...
        return Predicates.and(PathSelectors.regex("/template/rest/api/" + GreetingController.API_VERSION + ".*"),
